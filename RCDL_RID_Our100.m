...
GT_fpath = fullfile(GT_Original_image_dir, 'Canon_80D_ISO12800*.JPG');
TT_Original_image_dir = 'C:/Users/csjunxu/Desktop/CVPR2017/our_Results/Real_NoisyImage/';
TT_fpath = fullfile(TT_Original_image_dir, 'Canon_80D_ISO12800*.JPG'); 
...
load RCDL_RID_MAD1_Ran_ax1000_ay1_b100_gy0.001_20170404T132525.mat RCDL;
load 'C:/Users/csjunxu/Desktop/Projects/2017P1/GMM_108_1200000_101_Canon_80D_ISO12800_20170404T083510.mat';
...
for alphay =  [1]
    ...
    for alphax = [1000]
        ...
        for beta =  [100]
            ...
            for gammax = [1]
                Par.gammax = gammax;
                for gammay =  [0 0.0001 0.001 0.01 0.1 1]
                    Par.gammay = gammay;
                    for i = 1 : im_num
                        Par.ImInd = i;
