...
%     imwrite(Nim, 'noisy.png');
%     imwrite(Cim, 'clean.png');
...
% final results
patch_path = ['C:/Users/csjunxu/Desktop/Projects/2017P1/rnd_smp_patch_' num2str(Par.ps2ch) '_' num2str(Par.n_patch) '_' datestr(now, 30) '.mat'];
save(patch_path, 'Par', 'XN', 'XC', 'XN0', 'XC0');